...
| :---            |   :-----   | :-----                  |   :---:  | :---:    | :----       | :---: |
| Smart decor<br>aka Agiftforcrush     | EPS_WROOM32<br>TFT2,2" | Arduino_ESP<br> | C++ | IoT | A gift for crush (included HW).  | [link](https://github.com/hg-xnb/agiftforcursh/tree/main) |
