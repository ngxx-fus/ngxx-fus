...
| :---        |    :----:   |          :---: |          :---: |          :--- |
| Apply AT89C52 |C <br>(uVison Kiel C) | Embeded | finished | [AT89C52](https://github.com/ngxx-fus/MCU_AT89C52) Calendar (interface with DS1302); Stupid Home (IR Remote, Auto ON/OFF, ADC, Timer); Snake Game (IR Remote); Stupid Home (IR Remote, Bluetooth, Auto ON/OFF, ADC, Timer) | 
